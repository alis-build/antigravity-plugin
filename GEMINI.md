...
Skill routing for platform-shaped work happens through this plugin's `alis-build-discover`
skill — it activates from its own description, is quiet, local-first, and its own
instructions carry the contract. Generic coding (Makefiles, ordinary bugs, tests, git
